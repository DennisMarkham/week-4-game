...
var goalNumber: any = Math.floor(Math.random() * 90) + 11;
var playerNumber: any = 0;
var wins: any = localStorage.getItem("wins");
var losses: any = localStorage.getItem("losses");
...
//gives a random value to blue, green, red, and purple
 var blue: any = Math.floor(Math.random() * 10) + 1;
 var green: any= Math.floor(Math.random() * 10) + 1;
 var red: any = Math.floor(Math.random() * 10) + 1;
 var purple: any = Math.floor(Math.random() * 10) + 1; 
...
$(".exit").click(function():void{
     closeWindow();
});

function closeTimer():void{
  setTimeout(() => closeWindow(), 50000);
